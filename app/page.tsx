...
export const metadata: Metadata = {
  ...
  description: 'B2B SaaS для поиска и анализа покупателей металлопроката. AI-анализ финансов, снабжения и генерация персонализированных коммерческих предложений.',
