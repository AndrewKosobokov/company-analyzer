  ...
  return (
    <div className="page-container">
      ...
      <section className="hero">
        ...
        <p>
          Не работайте со складом. Работайте с аналитикой.
<br />
Искусственный интеллект, который сканирует предприятия и мгновенно находит вашу максимальную маржу, предоставляя глубокий и точный анализ закупочной стратегии и финансового здоровья клиента.
        </p>
